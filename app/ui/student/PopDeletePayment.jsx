...
const PopDeletePayment = ({onCansle , axios , id}) => {
  ...
  return (
    <div>
        ...
        <h1 className='mb-6 text-2xl md:text-3xl text-center text-color-red'>هل انت متأكد من حذف هذا الدفع للطالب </h1>
        <p className="text-color-text2 bg-side-color p-2 mb-4">بعد تأكيد الحذف سيتم حذف  الدفع للشهر المحدد</p>
        <div >
...
export default PopDeletePayment