...
const BoxSection = ({day , id , starttime , endtime , restartData }) => {
  ...
  return (
    <div className='img_liner  my-5 justify-between p-4 w-full  rounded-lg flex 2sm:text-lg md:text-xl'>
      {showPopDelete && (<div className="overlay"><PopDeleteSection id={id} onCansle={() =>setShowPopDelete(!showPopDelete)} restartData={restartData()}/> </div>)}
        <div>
