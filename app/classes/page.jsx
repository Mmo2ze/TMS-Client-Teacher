...
const page = () => {
    ...
    <ClassBox  axios={axios} studentsCount={da.studentsCount} updateData={updateData} name={da.name} id={da.id} basePaymentPrice={da.basePaymentPrice} basePaymentDelay={da.basePaymentDelay} grade={da.grade}/>
    ))}
      </div>
    </div>
  )}
